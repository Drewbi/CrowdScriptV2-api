...
const { getAllEpisodes, getEpisode, createEpisode, deleteEpisode, updateEpisode } = require('../_controllers/episode')
...
router.put('/api/episode', setUser, verifyAdmin, validateFields(['number']), updateEpisode)
